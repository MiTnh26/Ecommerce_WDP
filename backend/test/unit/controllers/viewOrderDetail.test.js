...
describe('SellerController › ViewOrderDetail', () => {
  ...
  describe('getOrderDetail', () => {
          ...
          Product: [
            {
              ...
              ProductVariant: [
                { _id: 'v1', ProductVariantName: 'Var1', Price: 10, Quantity: 2, Image: 'vimg.png' }
              ],
            }
          ],
        },
    ...
    it('500 on unexpected error', async () => {
      req.params.orderId = new mongoose.Types.ObjectId().toHexString();
      jest.spyOn(mongoose.Types.ObjectId, 'isValid').mockReturnValue(true);

      const err = new Error('boom');
      Order.findById.mockImplementation(() => { throw err; });
  ...
  describe('updateOrderStatus', () => {
    ...
    it('500 on unexpected error', async () => {
      ...
      Order.findByIdAndUpdate.mockImplementation(() => { throw err; });
