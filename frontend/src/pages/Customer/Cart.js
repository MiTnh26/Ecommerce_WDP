            ...
            <div className="d-flex align-items-center text-muted text-nowrap bg-white mt-2 py-3 px-1  overflow-auto ">
              ...
              <div className="flex-grow-1 d-flex gap-3">
                <img
                  ...
                  height={"80px"}
                />
                <p className="product-name text-wrap p-0 m-0">
                  Sản phẩm: Lorem ipsum dolor sit amet consectetur adipisicing
                  elit. Soluta voluptatibus Soll
                </p>
                <p
              ...
              <div className="flex-shrink-0 flex-basic-15 text-center">
                ...
                <p className="discount-price">10000</p>
              </div>
              <div className="flex-shrink-0 flex-basic-15 text-center">
                <div className="quantity-inputt d-flex justify-content-center">
                  ...
                  <input
                    type="number"
                    className="border bg-white py-1 px-2 text-center border-start-0 border-end-0 no-spinner"
                    style={{ width: "40px" }}
                  />
