    ...
    <div className="w-100 bg-light vh-100">
          <header className="">
              <div className="header-top bg-warning">
                  <div className="container d-flex justify-content-between py-1 align-items-center">
                      <a className=" text-decoration-none text-white" href="/Ecommerce/home">Home</a>
                      <div className="d-flex align-items-center">
                          <img src={logo} width={"30px"} height={"30px"} className="rounded-circle me-1" alt="img account" />
                          <a className=" text-decoration-none text-white" href="/Ecommerce/user/profile">Name Account</a>
                      </div>
                  </div>
              </div>
              <div className="header-bottom bg-white p-2">
                  <div className="container d-flex justify-content-between flex-wrap overflow-hidden align-items-center">
                      <div className="header-bottom-left d-flex gap-3 align-items-center">
                          <img src={logo} width={"80px"} height={"80px"} alt="img product"/>
                          ...
                          <form className="header-bottom-right d-flex " style={{ width: "100%", maxWidth: "350px" }}>
                              <input
                                  type="text"
                                  id="search"
          ...
          <main className="container-sm">
              <div className="cart-header d-flex align-items-center text-muted text-nowrap bg-white mt-2 py-3 px-1 rounder overflow-auto  rounded">
                  ...
                  <div className="flex-shrink-0 flex-basic-15 text-center"><p className="mb-0">Đơn giá</p></div>
                  <div className="flex-shrink-0 flex-basic-15 text-center"><p className="mb-0">Số lượng</p></div>
                  <div className="flex-shrink-0 flex-basic-15 text-center"><p className="mb-0">Số tiền</p></div>
                  <div className="flex-shrink-0 flex-basic-10 text-center"><p className="mb-0">Thao tác</p></div>
              </div>
          ...
          <footer className="container-sm bg-white fixed-bottom shadow">
            {/* <div className="d-flex gap-5 justify-content-end align-items-center py-3 border-bottom">
              ...
              <div className="d-flex gap-5 justify-content-between align-items-center py-3">
                  <div className="mx-3"><Form.Check type="checkbox" label={`Chọn tất cả (${count})`} /></div>
                  <div className="d-flex gap-3 align-items-center">
                  <p className="total-price p-0 m-0">
                      Tổng cộng({count} Sản Phẩm): <span className="text-danger">0</span>
                  </p>
                  <Button variant="outline-warning px-5 rounded-0">Mua hàng</Button>
                  </div>
              </div>
          </footer>
              <Modal show={showClassification} onHide={handleCloseClassification} centered size="md">
