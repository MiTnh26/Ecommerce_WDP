        ...
        ProductVariant: [
          {
            ...
            ProductVariantName:
              dataProduct.ProductVariant[currentIndex].ProductVariantName,
            Quantity: quantity,
          },
        ],
      };
              ...
              >
                      ...
                      <img
                        src={
                          currentIndex === -1
                            ...
                            : dataProduct?.ProductVariant[currentIndex].Image
                        }
                ...
                <section className="product-info-container flex-3 w-100">
                  ...
                  <div className="product-price d-flex align-items-center gap-2 mt-5 bg-light p-3">
                    ...
                    >
                      {currentIndex >= 0
                        ? dataProduct?.ProductVariant[
                            currentIndex
                          ].Price?.toLocaleString("vi-VN") || "Loading..."
                        : dataProduct?.ProductVariant[0].Price?.toLocaleString(
                            "vi-VN"
                          ) || "Loading..."}
                    </p>
                  </div>
                  ...
                  <div className="product-color mt-5 d-flex gap-2">
                    <p
                      className={`${styles["color-label"]}  p-0 m-0 text-muted`}
                    >
                      Product Variant
                    </p>
                    <div
                  ...
                  <div className="product-quantity mt-4 d-flex gap-2">
                    <p
                      className={`${styles["quantity-label"]} p-0 m-0 text-muted `}
                    >
                      Quantity
                    </p>
                    <div className="quantity-input d-flex align-items-center">
                      ...
                      <button
                        ...
                        disabled={
                          currentIndex >= 0
                            ? quantity ==
                              dataProduct?.ProductVariant[currentIndex]
                                .StockQuantity
                            : quantity ==
                              dataProduct?.ProductVariant[0].StockQuantity
                        }
                  ...
                  <div className="product-add-to-cart mt-4">
                    ...
                    >
                      <i className="fa-solid fa-cart-shopping fs-sx me-1"></i>
                      ADD TO CART
                    </button>
                    <button
