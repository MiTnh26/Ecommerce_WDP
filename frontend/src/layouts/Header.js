...
import { Col, Container, Row, Form, Offcanvas, ListGroup  } from 'react-bootstrap'
...
const Header = () => {
    ...
    return (
        <>
        <Container fluid>
            <Row className=" py-2 d-flex align-items-center" style={{borderBottom: '1px solid #f7f7f7'}}>
                {/* Responsive __sm md lg__ */}
                {/* Logo */}
                <Col sm={4} lg={2} className="order-lg-1 d-flex justify-content-md-start justify-content-center" >
                ...
                <Col md={12} lg={6} className='d-none d-md-block d-lg-block order-md-last order-lg-2 '>
                ...
                {/* Icon right header */}
                <Col sm={8} lg={4} className='order-lg-3 d-flex justify-content-sm-end align-items-center mt-4 mt-sm-0 justify-content-center '>
                        ...
                        <ul className="d-flex justify-content-end list-unstyled m-0 gap-2">
                            ...
                            <li>
                                <a href="/" className="d-flex align-items-center justify-content-center rounded-circle bg-light text-decoration-none" style={{ width: '50px', height: '50px' }}>
                        ...
                        {/* Cart dropdown */}
                        <div className="d-none d-lg-flex flex-column gap-2 lh-1 border-0 p-0 ms-5" onClick={handleShowCanvasCart}>
            ...
            {popUpSearch && (<><Row  className="d-block d-md-none">
            ...
            <Offcanvas show={showCanvasCart} onHide={handleShowCanvasCart} placement="end">
                <Offcanvas.Header className="d-flex justify-content-between">
                    <Offcanvas.Title>You Cart</Offcanvas.Title>
                    <div className="bg-warning  d-flex justify-content-center align-items-center rounded-circle" style={{width: '40px', height: '40px'}}>
                    ...
                    <ListGroup>
                        <ListGroup.Item className="px-0">
                           <div className="d-flex gap-2">
                            <img src={image} alt="" className="p-0 m-0"style={{width: '80px', height: '80px'}} />
